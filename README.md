...
# 1. Introduction
### Vagrant project to spin up a cluster of 4, 32-bit CentOS6.5 Linux virtual machines with Hadoop v2.6.5 and Spark v2.1.1. 
...
5. [Download Hadoop 2.6.5 into the /resources directory](http://apache.crihan.fr/dist/hadoop/common/hadoop-2.6.5/hadoop-2.6.5.tar.gz)
6. [Download Spark 2.1.1 into the /resources directory](https://d3kbcqa49mib13.cloudfront.net/spark-2.1.1-bin-hadoop2.6.tgz)
7. [Download Java 1.8 into the /resources directory](http://download.oracle.com/otn-pub/java/jdk/8u131-b11/d54c1d3a095b4ff2b6607d096fa80163/jdk-8u131-linux-i586.tar.gz)
...
line 4: JAVA_ARCHIVE=jdk-8u131-linux-i586.tar.gz  
To use a different version of Hadoop you've already downloaded to /resources directory, change the following line:  
line 8: ```HADOOP_VERSION=hadoop-2.6.5```  
To use a different version of Hadoop to be downloaded, change the remote URL in the following line:  
line 10: ```HADOOP_MIRROR_DOWNLOAD=http://apache.crihan.fr/dist/hadoop/common/hadoop-2.6.5/hadoop-2.6.5.tar.gz```  
To use a different version of Spark, change the following lines:  
line 13: ```SPARK_VERSION=spark-2.1.1```  
line 14: ```SPARK_ARCHIVE=$SPARK_VERSION-bin-hadoop2.6.tgz```  
line 15: ```SPARK_MIRROR_DOWNLOAD=../resources/spark-2.1.1-bin-hadoop2.6.tgz```  

3. /scripts/setup-java.sh  
To install from Java downloaded locally in /resources directory, if different from default version (1.8.0_131), change the version in the following line:  
line 18: ```ln -s /usr/local/jdk1.8.0_131 /usr/local/java```  
To modify version of Java to be installed from remote location on the web, change the version in the following line:  
line 12: ```yum install -y jdk-8u131-linux-i586```  
...
line 23: ```wget http://ftp.tu-chemnitz.de/pub/linux/dag/redhat/el6/en/i386/rpmforge/RPMS/sshpass-1.05-1.el6.rf.i686.rpm```  
